...
![pycharm_package.png](/images/pycharm_package.png)
...
![chat_with_botfather.png](/images/chat_with_botfather.png)
...
下面介绍在使用 Webhook 方式时，如何用最简单的方式将我们的机器人程序部署到 [Heroku](https://heroku.com) 云平台所提供的回调地址上
...
![pycharm_var.png](/images/pycharm_var.png)
