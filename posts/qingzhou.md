...
<span style="color: var(--vp-c-text-2); font-size: 14px;">📅 发布于：{{ $frontmatter.date ? new Date($frontmatter.date).toISOString().split('T')[0] : '' }}</span>
...
<ImageGallery dir="/images/qingzhou" />